...
# Basically, this is an easy way to iterate through lists with a pre-defined length,
# and by looking at the datasets can empirically determine at which point
# footprints reach a maximum size
